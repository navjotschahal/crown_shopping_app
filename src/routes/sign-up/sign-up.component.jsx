    ...
    return (
        <div className='sign-up-container'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <FormInputComponent label='Email' type="email" required onChange={handleChange} name='email' value={email}/>
                <FormInputComponent label='Password' type="password" required onChange={handleChange} name='password' value={password}/>
